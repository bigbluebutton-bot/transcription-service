...
class WhisperAIManager:
    ...
    def _execute(self, audio: np.ndarray, task: str, vad_segments: Optional[List[Dict[str, float | List[Tuple[float, float]]]]] = None) -> Tuple[List[WhisperModel.TranscriptionSegment], Dict]:
        if not self._models:
            self.load_model()
    ...
    def transcribe(self, audio: np.ndarray, vad_segments: Optional[List[Dict[str, float | List[Tuple[float, float]]]]] = None) -> Tuple[List[WhisperModel.TranscriptionSegment], Dict]:
        return self._execute(audio, "transcribe", vad_segments)

    def translate(self, audio: np.ndarray, vad_segments: Optional[List[Dict[str, float | List[Tuple[float, float]]]]] = None) -> Tuple[List[WhisperModel.TranscriptionSegment], Dict]:
        return self._execute(audio, "translate", vad_segments)
