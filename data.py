...
class AudioData:
    ...
    last_confimed_words: Optional[List[Word]] = None         # Last transcribed segments as text with timestamps
    ...
    vad_audio_confirmed_result: Optional[List[Dict[str, float | List[Tuple[float, float]]]]] = None # Voice activity detection result for confirmed audio
